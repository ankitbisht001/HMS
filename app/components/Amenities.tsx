...
<div className={style.amenityBox}>
        ...
        <div className={style.amenity}>
            ...
            <h4 className={style.amenityHead}>24/7 Room Service            </h4>
        ...
        <div className={style.amenity}>
            ...
            <p className={style.amenityText}>For your convenience, we provide a parking space and a valet to pick up and drop off your car.
        ...
        <div className={style.amenity}>
            ...
            <p className={style.amenityText}>Start your day with a refreshing breakfast made by our highly experienced kitchen staff with carefully picked ingredients and food that reminds you of home.
